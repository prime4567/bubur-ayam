<template>
    <div class="flex">
        <a :href=mapUrl>
            ...
            viewBox="0 0 512.01 512.01" width="21px">
            <g transform="translate(0 -1)">
                <g>
                    <g>
                        <path fill="var(--location-icon)" d="M388.89,314.055c-11.435-2.773-22.955,4.373-25.664,15.829c-2.731,11.456,4.373,22.955,15.829,25.664
                        ...
                        <path fill="var(--location-icon)" d="M256.015,171.681c11.776,0,21.333-9.557,21.333-21.333s-9.557-21.333-21.333-21.333s-21.333,9.557-21.333,21.333
                            S244.239,171.681,256.015,171.681z"/>
                        <path fill="var(--location-icon)" d="M228.239,398.518l8.683,17.365c3.627,7.232,11.008,11.797,19.093,11.797s15.467-4.565,19.093-11.797l18.389-36.779
...
export default {
  ...
  computed: {
    ...
    mapUrl() {
      ...
      return "https://www.google.com/maps/search/?api=1&query=" + JSON.parse(this.location).coordinates[1] + "," + JSON.parse(this.location).coordinates[0];
    }
  }
};
</script>